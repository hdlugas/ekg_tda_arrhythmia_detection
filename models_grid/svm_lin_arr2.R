...
for (l in 1:k){
  ...
  mod = svm(arr_flag ~ ., data=df_model_input[train_idxs,], kernel='linear')
...
write.csv(df_output, paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_svm_lin/arr2/accuracies_n', as.character(n), '.csv', sep=''), row.names = FALSE)
