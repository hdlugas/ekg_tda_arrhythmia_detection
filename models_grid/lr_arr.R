...
for (l in 1:k){
  ...
  path = paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_lr/arr/probs/n', 
                   as.character(n), '_fold', as.character(l), '.csv', sep='')
  write.csv(probs, path, row.names=TRUE)

  true_path = paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_lr/arr/lr_true_fold', as.character(l), '.csv', sep='')
