...
for (j in 1:length(param_list_ntrees)){
  ...
  for (i in 1:length(param_list_mtrys)){
    ...
    for (l in 1:k){
      ...
      path = paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_arr_vs_sr/rf_probs/rf_n', 
      ...
      if (j==1 & i==1){
        ...
        true_path = paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_arr_vs_sr/true/rf_true_fold', as.character(l), '.csv', sep='')
...
write.csv(df_output_rf, paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_arr_vs_sr/rf/accs_rf_n', as.character(n), '.csv', sep=''), row.names = FALSE)
