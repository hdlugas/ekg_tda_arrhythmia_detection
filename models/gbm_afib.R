...
for (j in 1:length(param_list_ntrees)){
  ...
  for (m in 1:length(param_list_interaction_depths)){
    ...
    for (l in 1:k){
      ...
      pred_path_response = paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_afib/gbm_probs/gbm_pred_response_n', 
                                 as.character(n), '_ntree', as.character(ntree), '_interactiondepth',
                                 as.character(interaction_depth), '_fold', as.character(l), '.csv', sep='')
      pred_path_link = paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_afib/gbm_probs/gbm_pred_link_n', 
                                 as.character(n), '_ntree', as.character(ntree), '_interactiondepth',
                                 as.character(interaction_depth), '_fold', as.character(l), '.csv', sep='')
      ...
      if (j==1 & m==1){
        ...
        true_path = paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_afib/true/gbm_true_fold', as.character(l), '.csv', sep='')
      ...
      true_preds = factor(df_model_input$afib_flag[test_idxs])
...
write.csv(df_output_gbm, paste('/wsu/home/fy/fy73/fy7392/ekg/afib2/ml_output_fib/gbm/accs_gbm_n', as.character(n), '.csv', sep=''), row.names = FALSE)
